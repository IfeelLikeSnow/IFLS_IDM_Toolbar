-- @description IFLS_IDM_Toolbar: IFLS MasterHub (migrated hub)
-- @version 1.0.2
-- @author IFLS_IDM_Toolbar
-- @about Migrated from legacy IFLS hub; adjusted internal paths to Scripts/IFLS_IDM_Toolbar.

-- IFLS_IDM_Toolbar (migrated) - IFLS_MasterHub_ImGui.lua
...
local core_path     = resource_path .. "/Scripts/IFLS_IDM_Toolbar/Core/"
local domain_path   = resource_path .. "/Scripts/IFLS_IDM_Toolbar/Domain/"
local hubs_path     = resource_path .. "/Scripts/IFLS_IDM_Toolbar/Hubs/"
local tools_path    = resource_path .. "/Scripts/IFLS_IDM_Toolbar/Tools/"
