...
local function draw(ctx)
  ...
  if ig.Button(ctx, "Open Scene Morph Hub") then
    local path = r.GetResourcePath() .. "/Scripts/IFLS_IDM_Toolbar/Hubs/IFLS_SceneMorphHub_ImGui.lua"
