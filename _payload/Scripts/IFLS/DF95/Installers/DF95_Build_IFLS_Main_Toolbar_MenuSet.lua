-- @description DF95: Build IFLS Main Toolbar MenuSet (v1.0.6 - full auto-install)
-- @version 1.0.6
...
--   [nomain] _payload/Scripts/DF95_IFLS_Rebuild_Toolbar_MenuSet.lua > Scripts/DF95_IFLS_Rebuild_Toolbar_MenuSet.lua
...
reaper.ClearConsole()
msg("DF95: Build IFLS Main Toolbar MenuSet (v1.0.6 - full auto-install)")
